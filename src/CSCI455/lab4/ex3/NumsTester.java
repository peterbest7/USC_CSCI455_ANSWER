...
public class NumsTester
{
   ...
   */
   public static void readNums(Nums nums) {
      String str = "";
      System.out.println("please enter a sequence of value in one line and split them by space and enter integer");
      System.out.print("please enter in this line(end by Ctrl + d): ");
